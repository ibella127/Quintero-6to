...
def get_tercer_año():
    """
    Se conecta a la base de datos y recupera todos los registros de la tabla Tercero Año.
    """
    conn = None
    cursor = None
    ...
    try:
        ...
        if conn.is_connected():
            ...
            cursor.execute("SELECT * FROM tercer_año")
            records = cursor.fetchall()

            if records:
                print("\n--- Estudiantes en Tercer Año ---")
                # 🛠️ Mejorar la impresión para hacerla más clara
                for row in records:
                    print(row)
            else:
                print("\nNo se encontraron estudiantes en la tabla tercero_año.")
    ...
    # 🛠️ CORRECCIÓN 2: Capturar errores más específicos y el timeout
        ...
        if err.errno == errorcode.ER_ACCESS_DENIED_ERROR:
            ...
            print("Error: La base de datos 'Tercero_db' no existe.")
